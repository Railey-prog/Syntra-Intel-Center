...
export default function Home() {
  ...
  const stats = [
    { value: "48.2%", label: "Human accuracy detecting AI faces — below chance" },
    { value: "7.7%", label: "AI faces rated more trustworthy than real ones" },
    { value: "44%", label: "Real faces mistakenly judged as AI-generated" },
  ];
